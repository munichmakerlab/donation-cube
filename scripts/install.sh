...
show_next_steps() {
    ...
    echo "   cd $PROJECT_NAME"
    echo ""
    echo "2. Use the interactive setup wizard:"
    echo "   python3 scripts/setup.py"
    echo ""
    echo "3. Or use direct commands:"
    echo "   python3 scripts/setup.py --config    # Configure settings"
    echo "   python3 scripts/setup.py --build     # Build firmware"
    echo "   python3 scripts/setup.py --flash TARGET  # Flash to device"
    echo ""
    echo "4. Use Makefile for common tasks:"
